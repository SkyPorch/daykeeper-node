...
| ------------------ | ------------------- | ------------------------------------------------- | ------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.2.0 (unreleased) | 0.2.0               | none yet — `daykeeper-openapi` PR #20 is unmerged | `226862442ce95447c813168b9c1d0f962a1a961d` (unreleased PR head snapshot) | Breaking: `Idempotency-Key` is required on flow mutations, and a replay answers `200` beside `201`. Not releasable until the contract is merged and tagged. |

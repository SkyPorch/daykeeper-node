...
| ----------- | ------------------- | ------------ | ------------------------------------------ | -------------------------------------------------------------------------------------------------------- |
| 0.3.0       | 1.3.0               | _unreleased_ | `fb205e6380755cff40441e434e36e935e8d1b48c` | Adds machine-owner workspace claims. Pinned to a tag `v1.3.0`; re-pin to the `v1.3.0` tag before release. |

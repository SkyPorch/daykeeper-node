...
| ----------- | ------------------- | ------------ | ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- |
| 0.3.0       | 1.4.0               | `v1.4.0`     | `488cc39c3604882742c88b08d90a664e3d82e515` | Adds machine-owner workspace claims; agent credentials last until revoked by default. Unpublished until the release is cut. |

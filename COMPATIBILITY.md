...
| ------------------ | ------------------- | ------------ | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 0.5.0 (unreleased) | 1.6.0               | untagged     | `a38cb493083876b7f2823bcb78aed988e757af8a` | Adds `agentCredentials.rotate`. Branch head of daykeeper-openapi `claude/agent-key-rotation`; re-pin to `v1.6.0` before release.                             |
